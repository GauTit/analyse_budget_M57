...
TEXTE_PERSONNALISE = """Le total des charges de fonctionnement comprend toutes les dépenses concernant le fonctionnement de la commune. Cela regroupe l'ensemble des opérations réelles et d'ordre, c'est-à-dire toutes les opérations qui entrainent ou pas des flux de trésorerie (décaissements ou non)."""

# ============================================
# CONFIGURATION DU POSTE
# ============================================

CHEMIN_JSON = "fonctionnement.charges.total"
NOM_POSTE = "Charges_de_fonctionnement"
...
def generer_prompt(data_json, texte_personnalise=None):
    """
    Génère le prompt complet pour le poste Charges_de_fonctionnement
