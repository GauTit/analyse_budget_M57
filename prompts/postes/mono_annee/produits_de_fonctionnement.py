"""
Poste budgétaire : Produits De Fonctionnement
Type : Mono-année
"""
...
TEXTE_PERSONNALISE = """Le total des produits de fonctionnement comprend toutes les recettes concernant le fonctionnement de la commune. Cela regroupe l'ensemble des opérations réelles et d'ordre, c'est-à-dire toutes les opérations qui entrainent ou pas des flux de trésorerie (encaissements ou non)."""

# ============================================
# CONFIGURATION DU POSTE
# ============================================

CHEMIN_JSON = "fonctionnement.produits.total"
NOM_POSTE = "Produits_de_fonctionnement"
...
def generer_prompt(data_json, texte_personnalise=None):
    """
    Génère le prompt complet pour le poste Produits_de_fonctionnement
