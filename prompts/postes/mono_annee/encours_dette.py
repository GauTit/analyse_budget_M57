"""
Poste budgétaire : Encours Dette
Type : Mono-année
"""
...
TEXTE_PERSONNALISE = """L'encours de dette constitue un poste majeur du passif financier de la commune, représentant un levier important de financement des investissements."""

# ============================================
# CONFIGURATION DU POSTE
# ============================================

CHEMIN_JSON = "endettement.encours_total"
NOM_POSTE = "Encours_dette"
...
def generer_prompt(data_json, texte_personnalise=None):
    """
    Génère le prompt complet pour le poste Encours_dette
