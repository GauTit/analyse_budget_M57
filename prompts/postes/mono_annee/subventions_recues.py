"""
Poste budgétaire : Subventions Recues
Type : Mono-année
"""
...
TEXTE_PERSONNALISE = """Les subventions reçues constituent une ressource d'investissement non remboursable, dont le niveau conditionne le reste à charge de la collectivité sur ses opérations d'équipement."""

# ============================================
# CONFIGURATION DU POSTE
# ============================================

CHEMIN_JSON = "investissement.ressources.subventions_recues"
NOM_POSTE = "Subventions_recues"
...
def generer_prompt(data_json, texte_personnalise=None):
    """
    Génère le prompt complet pour le poste Subventions_recues
