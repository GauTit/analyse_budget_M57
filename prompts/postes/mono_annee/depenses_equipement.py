"""
Poste budgétaire : Depenses Equipement
Type : Mono-année
"""
...
TEXTE_PERSONNALISE = """Les dépenses d'équipement constituent les investissements réalisés par la commune sur l'exercice, principalement dans les immobilisations corporelles et incorporelles, ainsi que les immobilisations en cours. Les dépenses d'équipement peuvent être traduites « en opération d'équipement »."""

# ============================================
# CONFIGURATION DU POSTE
# ============================================

CHEMIN_JSON = "investissement.emplois.depenses_equipement"
NOM_POSTE = "Depenses_equipement"
...
def generer_prompt(data_json, texte_personnalise=None):
    """
    Génère le prompt complet pour le poste Depenses_equipement
