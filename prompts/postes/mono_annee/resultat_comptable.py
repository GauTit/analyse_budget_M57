"""
Poste budgétaire : Resultat Comptable
Type : Mono-année
"""
...
TEXTE_PERSONNALISE = """Le résultat comptable est la différence entre le total des produits de fonctionnement et le total des charges de fonctionnement. Il traduit la couverture (ou non, s'il est négatif) des charges de fonctionnement (dépenses) par les produits de fonctionnement (recettes)."""

# ============================================
# CONFIGURATION DU POSTE
# ============================================

CHEMIN_JSON = "fonctionnement.resultat"
NOM_POSTE = "Resultat_comptable"
...
def generer_prompt(data_json, texte_personnalise=None):
    """
    Génère le prompt complet pour le poste Resultat_comptable
