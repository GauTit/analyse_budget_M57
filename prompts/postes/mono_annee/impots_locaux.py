"""
Poste budgétaire : Impots Locaux
Type : Mono-année
"""
...
TEXTE_PERSONNALISE = """Les impots locaux constituent un poste de recettes important. On y trouve, principalement, les produits issus de la fiscalité directe locale."""

# ============================================
# CONFIGURATION DU POSTE
# ============================================

CHEMIN_JSON = "fonctionnement.produits.impots_locaux"
NOM_POSTE = "Impots_locaux"
...
def generer_prompt(data_json, texte_personnalise=None):
    """
    Génère le prompt complet pour le poste Impots_locaux
