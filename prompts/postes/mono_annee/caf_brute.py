...
TEXTE_PERSONNALISE = """La CAF brute constitue l'indicateur principal de la capacité de la commune à générer un excédent de ressources issu du fonctionnement avant remboursement du capital de la dette, servant de levier potentiel pour le financement de la section d'investissement."""

# ============================================
# CONFIGURATION DU POSTE
# ============================================

CHEMIN_JSON = "autofinancement.caf_brute"
NOM_POSTE = "CAF_brute"
...
def generer_prompt(data_json, texte_personnalise=None):
    """
    Génère le prompt complet pour le poste CAF_brute
