...
TEXTE_PERSONNALISE = """La CAF nette représente l'autofinancement effectivement disponible pour financer la section d'investissement après remboursement en capital de la dette, constituant un indicateur clé de la capacité financière de la commune."""

# ============================================
# CONFIGURATION DU POSTE
# ============================================

CHEMIN_JSON = "autofinancement.caf_nette"
NOM_POSTE = "CAF_nette"
...
def generer_prompt(data_json, texte_personnalise=None):
    """
    Génère le prompt complet pour le poste CAF_nette
