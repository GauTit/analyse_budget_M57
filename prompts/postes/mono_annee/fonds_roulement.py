"""
Poste budgétaire : Fonds Roulement
Type : Mono-année
"""
...
TEXTE_PERSONNALISE = """Le fonds de roulement constitue un poste majeur dans la structure financière de la commune, traduisant la capacité cumulée à couvrir le besoin en fonds de roulement et la trésorerie."""

# ============================================
# CONFIGURATION DU POSTE
# ============================================

CHEMIN_JSON = "endettement.fonds_roulement"
NOM_POSTE = "Fonds_roulement"
...
def generer_prompt(data_json, texte_personnalise=None):
    """
    Génère le prompt complet pour le poste Fonds_roulement
