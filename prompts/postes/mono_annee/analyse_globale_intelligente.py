"""
Poste budgétaire : Analyse Globale Intelligente
Type : Mono-année
"""
...
CONTEXTE_ESSENTIEL = """L'ESSENTIEL DE LA SYNTHÈSE GLOBALE :
...
CHEMIN_JSON = "metadata"
NOM_POSTE = "Analyse_globale_intelligente"
...
def generer_prompt(data_json, texte_personnalise=None):
    """
    Génère le prompt complet pour le poste Analyse_globale_intelligente
