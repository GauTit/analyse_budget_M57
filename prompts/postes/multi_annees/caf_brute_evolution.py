"""
Poste budgétaire : CAPACITÉ D'AUTOFINANCEMENT BRUTE (CAF BRUTE)
Type : Multi-années (évolution)
"""

from prompts import regles_globales
from prompts.postes.mono_annee import caf_brute

# ============================================
# CONFIGURATION DU POSTE
# ============================================

NOM_POSTE = "CAF_brute_evolution"
NOM_COMPLET = "CAPACITÉ D'AUTOFINANCEMENT BRUTE (CAF BRUTE)"
TYPE_RAPPORT = "Multi-annees"
CLE_TENDANCE = "caf_brute"  # None pour Analyse_tendances_globales, sinon clé du JSON tendances

# Utiliser le contexte essentiel du poste mono-année correspondant
CONTEXTE_ESSENTIEL = CAF_brute.CONTEXTE_ESSENTIEL

# ============================================
# CONSIGNES D'ANALYSE MULTI-ANNÉES
# ============================================

CONSIGNES_ANALYSE = """POSTE BUDGÉTAIRE À ANALYSER : CAPACITÉ D'AUTOFINANCEMENT BRUTE (CAF BRUTE)

CONSIGNES D'ANALYSE PLURIANNUELLE – RÉFÉRENTIEL M57 :

Rédiger une analyse pluriannuelle synthétique du poste "CAPACITÉ D'AUTOFINANCEMENT BRUTE (CAF BRUTE)" (max 150 mots).
