"""
Poste budgétaire : DÉPENSES D'ÉQUIPEMENT
Type : Multi-années (évolution)
"""

from prompts import regles_globales
from prompts.postes.mono_annee import depenses_equipement

# ============================================
# CONFIGURATION DU POSTE
# ============================================

NOM_POSTE = "Depenses_equipement_evolution"
NOM_COMPLET = "DÉPENSES D'ÉQUIPEMENT"
TYPE_RAPPORT = "Multi-annees"
CLE_TENDANCE = "depenses_equipement"  # None pour Analyse_tendances_globales, sinon clé du JSON tendances

# Utiliser le contexte essentiel du poste mono-année correspondant
CONTEXTE_ESSENTIEL = Depenses_equipement.CONTEXTE_ESSENTIEL

# ============================================
# CONSIGNES D'ANALYSE MULTI-ANNÉES
# ============================================

CONSIGNES_ANALYSE = """POSTE BUDGÉTAIRE À ANALYSER : DÉPENSES D'ÉQUIPEMENT

CONSIGNES D'ANALYSE PLURIANNUELLE – RÉFÉRENTIEL M57 :

Rédiger une analyse pluriannuelle synthétique du poste "DÉPENSES D'ÉQUIPEMENT" (max 150 mots).
