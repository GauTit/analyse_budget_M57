...
from prompts.postes.mono_annee import produits_de_fonctionnement
...
CLE_TENDANCE = "produits_fonctionnement"  # None pour Analyse_tendances_globales, sinon clé du JSON tendances

# Utiliser le contexte essentiel du poste mono-année correspondant
CONTEXTE_ESSENTIEL = Produits_de_fonctionnement.CONTEXTE_ESSENTIEL

# ============================================
# CONSIGNES D'ANALYSE MULTI-ANNÉES
# ============================================

CONSIGNES_ANALYSE = """POSTE BUDGÉTAIRE À ANALYSER : PRODUITS DE FONCTIONNEMENT

CONSIGNES D'ANALYSE PLURIANNUELLE – RÉFÉRENTIEL M57 :

Rédiger une analyse pluriannuelle synthétique du poste "PRODUITS DE FONCTIONNEMENT" (max 150 mots).
