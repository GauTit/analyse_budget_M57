"""
Poste budgétaire : CHARGES DE FONCTIONNEMENT
Type : Multi-années (évolution)
"""

from prompts import regles_globales
from prompts.postes.mono_annee import charges_de_fonctionnement

# ============================================
# CONFIGURATION DU POSTE
# ============================================

NOM_POSTE = "Charges_fonctionnement_evolution"
NOM_COMPLET = "CHARGES DE FONCTIONNEMENT"
TYPE_RAPPORT = "Multi-annees"
CLE_TENDANCE = "charges_fonctionnement"  # None pour Analyse_tendances_globales, sinon clé du JSON tendances

# Utiliser le contexte essentiel du poste mono-année correspondant
CONTEXTE_ESSENTIEL = Charges_de_fonctionnement.CONTEXTE_ESSENTIEL

# ============================================
# CONSIGNES D'ANALYSE MULTI-ANNÉES
# ============================================

CONSIGNES_ANALYSE = """POSTE BUDGÉTAIRE À ANALYSER : CHARGES DE FONCTIONNEMENT

CONSIGNES D'ANALYSE PLURIANNUELLE – RÉFÉRENTIEL M57 :

Rédiger une analyse pluriannuelle synthétique du poste "CHARGES DE FONCTIONNEMENT" (max 150 mots).
