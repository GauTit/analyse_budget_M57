"""
Poste budgétaire : CHARGES DE PERSONNEL
Type : Multi-années (évolution)
"""

from prompts import regles_globales
from prompts.postes.mono_annee import charges_de_personnel

# ============================================
# CONFIGURATION DU POSTE
# ============================================

NOM_POSTE = "Charges_personnel_evolution"
NOM_COMPLET = "CHARGES DE PERSONNEL"
TYPE_RAPPORT = "Multi-annees"
CLE_TENDANCE = "charges_personnel"  # None pour Analyse_tendances_globales, sinon clé du JSON tendances

# Utiliser le contexte essentiel du poste mono-année correspondant
CONTEXTE_ESSENTIEL = Charges_de_personnel.CONTEXTE_ESSENTIEL

# ============================================
# CONSIGNES D'ANALYSE MULTI-ANNÉES
# ============================================

CONSIGNES_ANALYSE = """POSTE BUDGÉTAIRE À ANALYSER : CHARGES DE PERSONNEL

CONSIGNES D'ANALYSE PLURIANNUELLE – RÉFÉRENTIEL M57 :

Rédiger une analyse pluriannuelle synthétique du poste "CHARGES DE PERSONNEL" (max 150 mots).
